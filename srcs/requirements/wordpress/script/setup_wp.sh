...
sleep 2
wp core install     --url=loumouli.42.fr --title=Inception-42 --admin_user=$WP_ADMIN_USER --admin_password=$WP_ADMIN_PASSWORD --admin_email=$WP_ADMIN_MAIL --allow-root --path='/var/www/wordpress'
